  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light shadow fixed-sidebar" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="{{route('home')}}" class="d-flex align-items-center list-group-item list-group-item-action hover-bg-green rounded">
        ...
        <a href="" class="d-flex align-items-center list-group-item list-group-item-action hover-bg-green rounded">
          <svg class="mr-2" style="width:24px;height:24px" viewBox="0 0 24 24">
