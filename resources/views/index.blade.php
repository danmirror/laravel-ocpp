  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light shadow fixed-sidebar" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="{{route('home')}}" class="d-flex align-items-center list-group-item list-group-item-action hover-blue-violet rounded">
      ...
      <div class="container content">
        <h3 class="mt-2 mb-4 title">Dashboard</h3>
				...
				<div class="row justify-content-around ">
					...
					<div class="col-sm-2 margin-left mb-2">
						<div class="card border-left-second shadow " >
								<div class="card-body">
										<div class=" font-weight-bold text-primary text-uppercase mb-1">
												
										</div>
										<div class="h5 mb-0 font-weight-bold text-gray-800">ppm</div>
								</div>
						</div>
					</div>
					<div class="col-sm-2 margin-left mb-2">
						<div class="card border-left-second shadow " >
								<div class="card-body">
										...
										<div class="h5 mb-0 font-weight-bold text-gray-800">5 ppm</div>
								</div>
						</div>
					</div>
					<div class="col-sm-2 margin-left mb-2">
        ...
        <div class="container-content shadow mt-5">
          <div class="row justify-content-between ">
            <div class="ml-2 col-6 mb-4">
              <h4 class="font mb-1">Details Data</h4 >
            </div>
          </div>
